...
<html>
<head>
    <title>Monthly Vechile Maintainance</title>
...
<?php
    ...
    // Take some time to understand this query!
		$query  = "SELECT * FROM vehiclemaintenance WHERE MONTH( DATE ) = MONTH( DATE_SUB(CURDATE(),INTERVAL 1 MONTH )) 		\n";
...
$stmt->execute();
?>
<h2>Monthly Vechile Maintaiance </h2>
<table>
