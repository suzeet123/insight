...
<html>
<head>
    <title>Quarterly Vechile Maintainance</title>
...
<?php
    ...
    // Take some time to understand this query!
		$query  = "SELECT * FROM vehiclemaintenance WHERE MONTH( DATE ) = MONTH( DATE_SUB(CURDATE(),INTERVAL 3 MONTH ))		\n";
...
$stmt->execute();
?>
<h2>Quaterly Vechile Maintaiance </h2>
<table>
